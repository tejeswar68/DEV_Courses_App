...
function Business() {
  ...
  useEffect(()=>{
    axios.get("https://learnershub.herokuapp.com/api/course/bytopic/Business")
  ...
  return (
    ...
    <div >
    <h2 className='mt-5 fw-bold'>Business Courses</h2>
    ...
    <Carousel interval={2000}>
      ...
      <div className='row container fw-bold text-center'>
      <p className="col-sm border pt-3 pb-3 me-1">Web Business
        </p>
        <p className="col-sm border pt-3 pb-3 me-1">
          Java
        </p>
      ...
      <h4 className='fw-bold mt-5'>All Business Courses</h4>
